...
namespace GrocerySupplyManagementApp.Forms
{
    public partial class UserListForm : Form
    {
        ...
        private void DataGridUserList_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            DataGridUserList.Columns["DailyExpense"].Visible = false;
            ...
            DataGridUserList.Columns["Report"].Visible = false;
            DataGridUserList.Columns["Setting"].Visible = false;
            DataGridUserList.Columns["Stock"].Visible = false;
