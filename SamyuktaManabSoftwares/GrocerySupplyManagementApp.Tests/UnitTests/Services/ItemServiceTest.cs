    ...
    public class ItemServiceTest
    {
        ...
        public void GetItems_ReturnsItems()
        {
            _itemRepository.Setup(repo => repo.GetItems())
                ...
                new Item() { Id = 1, EndOfDay = "2078-01-01", Code = "Code1", Name = "Item Name 1", Brand = "Brand1" , AddedBy = "TestUser1", Unit = Constants.KILOGRAM, Threshold = 10, AddedDate = DateTime.Parse("2078-01-01"), UpdatedBy = null, UpdatedDate = null },
                new Item() { Id = 2, EndOfDay = "2078-02-02", Code = "Code2", Name = "Item Name 2", Brand = "Brand2" , AddedBy = "TestUser2", Unit = Constants.LITER, Threshold = 20,  AddedDate = DateTime.Parse("2078-02-02"), UpdatedBy = null, UpdatedDate = null }
            });
